...
HD_PWD='C:/Users/ECE/Desktop/LSTM_IOT_SEC/softmax/softmax.runs/SRAM_64x283_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SRAM_64x283.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SRAM_64x283.tcl
