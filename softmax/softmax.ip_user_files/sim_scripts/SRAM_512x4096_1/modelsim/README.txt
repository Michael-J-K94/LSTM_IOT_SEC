...
#
# Generated by export_simulation on Wed May 15 20:02:33 +0900 2019
#
################################################################################
...
'-reset_run' switch to the './SRAM_512x4096.sh' script.

./SRAM_512x4096.sh -reset_run
...
./SRAM_512x4096.sh -noclean_files

For more information on the script, please type './SRAM_512x4096.sh -help'.
