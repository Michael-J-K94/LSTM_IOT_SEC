...
#
# Generated by export_simulation on Wed May 15 20:06:39 +0900 2019
#
################################################################################
...
'-reset_run' switch to the './SRAM_8x4096.sh' script.

./SRAM_8x4096.sh -reset_run
...
./SRAM_8x4096.sh -noclean_files

For more information on the script, please type './SRAM_8x4096.sh -help'.
