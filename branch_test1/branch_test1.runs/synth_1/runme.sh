...
HD_PWD='C:/Users/ECE/Desktop/LSTM_IOT_SEC/branch_test1/branch_test1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LSTM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LSTM.tcl
