...
HD_PWD='C:/Users/ECE/Desktop/LSTM_IOT_SEC/ctxt_convert_test/ctxt_convert_test.runs/SRAM_128x2048_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SRAM_128x2048.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SRAM_128x2048.tcl
