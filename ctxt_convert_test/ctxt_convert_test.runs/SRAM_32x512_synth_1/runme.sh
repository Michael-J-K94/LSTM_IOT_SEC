...
HD_PWD='C:/Users/ECE/Desktop/LSTM_IOT_SEC/ctxt_convert_test/ctxt_convert_test.runs/SRAM_32x512_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SRAM_32x512.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SRAM_32x512.tcl
