...
HD_PWD='C:/Users/User/Desktop/LSTM_IOT_SEC/test/test.runs/SRAM_16x512_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SRAM_16x512.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SRAM_16x512.tcl
