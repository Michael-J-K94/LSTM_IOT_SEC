...
HD_PWD='C:/Users/ECE/project_1/project_1.runs/BRAM_16x512_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BRAM_16x512.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BRAM_16x512.tcl
