...
HD_PWD='C:/Users/User/Desktop/LSTM_IOT_SEC/project_1/project_1.runs/SRAM_512x128_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SRAM_512x128.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SRAM_512x128.tcl
