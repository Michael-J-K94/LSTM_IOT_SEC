...
HD_PWD='C:/Users/ECE/project_1/project_1.runs/BRAM_128x2048_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BRAM_128x2048.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BRAM_128x2048.tcl
