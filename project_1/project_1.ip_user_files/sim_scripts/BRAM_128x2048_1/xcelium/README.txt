...
#
# Generated by export_simulation on Sat May 04 22:14:13 +0900 2019
#
################################################################################
...
'-reset_run' switch to the './BRAM_128x2048.sh' script.

./BRAM_128x2048.sh -reset_run
...
./BRAM_128x2048.sh -noclean_files

For more information on the script, please type './BRAM_128x2048.sh -help'.
